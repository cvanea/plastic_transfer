...
run_1 = Run('exp_15', 50, hp, save_opp=hp.save_opp)
...
run_2 = Run('exp_15', 51, hp2, save_opp=hp2.save_opp)
...
run_3 = Run('exp_15', 52, hp3, save_opp=hp3.save_opp)
...
run_4 = Run('exp_15', 53, hp4, save_opp=hp4.save_opp)
...
hp5.source_animal = "car"
hp5.target_animal = "ship"
hp5.pruning_dataset = "p_target"
hp5.save_opp = True
hp5.labels_per_category = 500
hp5.reinit_weights = False

run_5 = Run('exp_15', 54, hp5, save_opp=hp5.save_opp)
...
hp6.source_animal = "car"
hp6.target_animal = "plane"
hp6.pruning_dataset = "p_target"
hp6.save_opp = True
hp6.labels_per_category = 500
hp6.reinit_weights = False

run_6 = Run('exp_15', 55, hp6, save_opp=hp6.save_opp)
...
run_7 = Run('exp_15', 56, hp7, save_opp=hp7.save_opp)
